...
import {projects_social_housing} from "../../common/constants";
  ...
  return (
    <div className="bg-gray-100 py-8 sm:py-12 md:py-16 px-3 sm:px-4 md:px-6 pt-24 sm:pt-32 md:pt-28">
      ...
      <div className="container mx-auto max-w-6xl">
        <button
          type="button"
          onClick={() => router.push('/projects?category=completed#portfolio')}
      ...
      <div className="container mx-auto max-w-6xl">
        {projects_social_housing.map((project, index) => (
          <motion.div
            key={index}
