...
const services: Service[] = [
  {
    ...
    description:
      "We have been involved in conjunction with various local authorities across Ireland for the provision of social housing. We specialise in Long-term leasing, the rsocial housing and are educated in all the planning exemptions available across Ireland.",
